...
public:
  ...
  void handleOverlayDraw() override {
    ...
    // Race mode owns every matrix pixel. Clearing the complete segment prevents
    // WLED effects or stale layouts from appearing through unused race pixels.
...
private:
  ...
  void readDisplayControls(JsonObjectConst command, uint8_t& brightnessPercent) {
    if (command.containsKey("brightness")) brightnessPercent = constrain(command["brightness"].as<int>(), 0, 100);
  }

  void applyDisplayControls(uint8_t brightnessPercent) {
