...
const checks = [
  ...
  [webUi.includes('value="inward">Current heat · Inward chevrons') && webUi.includes('value="upward">Staged · Upward chevrons') && webUi.includes('value="right-single">Next up · Right chevrons') && webUi.includes('value="right-double">Next +2 · Double right chevrons'), 'header options must map the four race states to their chevrons'],
